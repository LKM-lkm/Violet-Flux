...
.nav a { font-size: 0.9375rem; color: var(--text-secondary); text-decoration: none; font-weight: 500; transition: color 0.2s; }
...
.toc-title { font-family: 'Bricolage Grotesque'; font-size: 0.75rem; text-transform: uppercase; font-weight: 800; letter-spacing: 0.1em; color: var(--text-secondary); }

.toc { position: relative; border-left: 1px solid var(--border-light); }
...
.article-body :deep(h2) { font-size: 2.25rem; border-bottom: 1px solid var(--border-light); padding-bottom: 0.75rem; }
